...
import { RequireAdmin, RequireAuth, RequireManager } from './components/ProtectedRoute'
...
import AdminRestaurantRequests from './pages/admin/AdminRestaurantRequests'
    ...
    <Routes>
      ...
      <Route element={<RequireAdmin />}>
        <Route path="/admin" element={<AdminLayout />}>
          ...
          <Route path="restaurant-requests" element={<AdminRestaurantRequests />} />
      ...
      <Route element={<RequireManager />}>
        <Route path="/manager" element={<ManagerLayout />}>
          ...
          <Route path="menu-items" element={<ManagerMenuItems />} />
        </Route>
      </Route>
